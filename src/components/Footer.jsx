  ...
  return (
    <div className='bg-slate-50 dark:bg-gray-900 pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
      ...
      <div className='flex flex-col lg:flex-row justify-between items-start gap-10'>
        <div className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
            ...
            <ul className='flex gap-2 mb-7'>
                ...
                <li><a className='hover:text-primary' href="#Our-works">Our works</a></li>
        ...
        <div className='text-gray-600 dark:text-gray-400'>
            ...
            <div className='flex gap-2 text-sm'>
                <input type="email" placeholder='Enter your email' className='w-full p-3 text-sm outine-none rounded dark:text-gray-200 bg-transparent border border-gray-300 dark:border-gray-500' />
      ...
      <div className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap=4 flex-wrap'>
        <p>Copyright 2025 agency.io - Codewitheklavya - All Right Reserved</p>
